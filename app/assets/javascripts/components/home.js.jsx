    ...
    return (
      <div className="home-container">
        ...
        <div className="footer">
          <div className="contact"><a href="http://billylittlefield.com/">&copy; Billy Littlefield</a> | <a href="https://www.linkedin.com/pub/billy-littlefield/25/b5/b74">Contact</a></div>
